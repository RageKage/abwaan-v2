      ...
      <div class="grid lg:grid-cols-12 border-b border-gray-200">
        <div class="lg:col-span-12 p-12 lg:p-20 bg-gray-50">
          <div class="max-w-3xl">
            ...
            <h1 class="text-5xl md:text-7xl font-serif tracking-tighter text-gray-900 mb-6">Contribute to History.</h1>
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="grid lg:grid-cols-12 border-b border-gray-200">
          <div class="lg:col-span-4 p-10 lg:p-12 border-b lg:border-b-0 lg:border-r border-gray-200 bg-gray-50">
            ...
            <p class="mt-4 text-sm text-gray-500 leading-relaxed">Enter the text exactly as it is spoken or written.</p>
          </div>
        ...
        <div class="grid lg:grid-cols-12 border-b border-gray-200">
          <div class="lg:col-span-4 p-10 lg:p-12 border-b lg:border-b-0 lg:border-r border-gray-200 bg-gray-50">
            ...
            <p class="mt-4 text-sm text-gray-500 leading-relaxed">The hidden meaning or translation of this piece.</p>
          </div>
