  ...
  <div class="w-full font-sans text-gray-900 pt-24 pb-24">
    ...
    <header class="border-b border-gray-200">
      <div class="max-w-[1600px] mx-auto grid lg:grid-cols-12 min-h-[85vh]">
        ...
        <div class="lg:col-span-7 flex flex-col justify-between p-8 md:p-16 lg:p-24 border-r border-gray-200 relative bg-white">
          ...
          <div class="relative z-10 space-y-8">
            ...
            >
              A digital home for <span class="font-serif italic text-gray-900">Gabay</span> (Poetry) & <span class="font-serif italic text-gray-900">Maahmaahyo</span> (Proverbs).
            </p>
          </div>
        </div>
        ...
        <div class="lg:col-span-5 relative group bg-gray-50 flex items-center justify-center p-12">
            ...
            <div class="relative w-full max-w-md shadow-2xl shadow-gray-200 bg-white p-4 rotate-1 group-hover:rotate-0 transition-transform duration-700 h-fit">
    ...
    <section class="border-b border-gray-200 bg-white">
      <div class="max-w-[1600px] mx-auto grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
        ...
        >
          <span class="absolute top-8 right-8 text-xs font-mono text-gray-300 group-hover:text-carrotOrange-500 transition-colors">01</span>
        ...
        >
          <span class="absolute top-8 right-8 text-xs font-mono text-gray-300 group-hover:text-carrotOrange-500 transition-colors">02</span>
          <div class="space-y-6 relative z-10">
            <span class="text-xs font-bold uppercase tracking-[0.3em] text-carrotOrange-600 block mb-2">Short Form</span>
            <h3 class="text-5xl md:text-6xl font-serif text-gray-900 group-hover:translate-x-2 transition-transform duration-300">Maahmaahyo</h3>
            <p class="text-gray-500 max-w-sm leading-relaxed border-l border-gray-200 pl-4 group-hover:border-gray-900 transition-colors">
