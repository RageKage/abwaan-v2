  ...
  <div class="selection:bg-gray-900 selection:text-white font-sans text-gray-900 pt-24">
    <div class="max-w-[1600px] mx-auto border-l border-r border-gray-200">
      ...
      <header class="border-b border-gray-200 bg-white p-10 lg:p-20">
        <div class="max-w-4xl">
           <span class="inline-block px-3 py-1 border border-gray-900 rounded-full text-[10px] font-bold uppercase tracking-widest w-fit mb-6">
              Project Status
           </span>
           <h1 class="text-6xl md:text-8xl font-serif tracking-tighter leading-none text-gray-900 mb-8">
             The Roadmap.
           </h1>
      ...
      <div class="grid lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 border-b border-gray-200 bg-gray-50">

        <div
          v-for="phase in phases"
          :key="phase.id"
          class="flex flex-col min-h-[60vh]"
        >
          ...
          <div class="flex-1 bg-gray-50 flex flex-col">
             ...
             >
                <div class="p-8 lg:p-10 flex items-start justify-between relative z-10">
                   <h3 class="text-lg font-serif text-gray-900 group-hover:text-carrotOrange-600 transition-colors duration-300">
                      {{ item.title }}
                   </h3>
                   <span class="text-gray-300 group-hover:text-carrotOrange-500 transition-colors duration-300 text-xl font-light">
                ...
                <div
                  ...
                  :class="activeItemId === item.id ? 'max-h-48 opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-4'"
                >
      ...
      <div class="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
         <div class="p-12 lg:p-24 bg-white flex flex-col justify-center">
            ...
            <a href="mailto:nimanahmed000@gmail.com" class="text-carrotOrange-600 font-bold uppercase text-xs tracking-widest hover:text-gray-900 transition-colors">
               Submit Feature Request &rarr;
            </a>
         </div>
         <div class="p-12 lg:p-24 bg-gray-900 text-white flex flex-col justify-center items-start">
            <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-4">
               Live Beta
            </span>
